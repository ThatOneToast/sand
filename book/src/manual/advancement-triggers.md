...
Builders in `sand_core::event::trigger` create `AdvancementTrigger` values: `UsingItemTrigger`, `ConsumeItemTrigger`, inventory/craft/enchant/kill triggers, `PlayerInteractedWithEntityTrigger`, and `SummonedEntityTrigger`.
