...
5. `sand/build.rs` runs that graph and scope audit during ordinary
   ...
   crates, partitions all 10,900 static identities in the latest profile, and byte-compares the
...
select a separate exact 4,800-item source-plus-checked-in-generator profile; they cannot be mixed
