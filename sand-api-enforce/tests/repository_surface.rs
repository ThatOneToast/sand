...
fn checked_repository_surface_baseline_is_complete_and_partitioned() {
    ...
    assert_eq!(kinds.values().sum::<usize>(), 11_014);
    ...
    assert_eq!(origins.values().sum::<usize>(), 11_014);
    assert_eq!(origins["source"], 4_646);
...
fn checked_repository_profiles_bind_exact_versioned_baselines() {
    ...
    let expected = [
        ("placeholder-codegen", 4_914, 0, 0, 0),
        ("1.21.4", 10_104, 902, 4_288, 0),
        ("26.2", 11_014, 1_233, 4_867, 0),
    ];
