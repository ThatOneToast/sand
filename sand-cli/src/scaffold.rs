...
mod tests {
    ...
    fn scaffold_writes_files() {
        ...
        // advancement/tick #[datapack_component].
        assert!(lib_rs.contains("#[on_event]"));
        assert!(lib_rs.contains("OnJoinEvent"));
        assert!(lib_rs.contains("Event<OnJoinEvent>"));
        assert!(!lib_rs.contains("#[datapack_component]"));
        assert!(!lib_rs.contains("AdvancementTrigger::Tick"));
        assert!(lib_rs.contains("__sand_export"));
        assert!(
            lib_rs.contains("sand::advanced::try_export_components_json(namespace, mc_version)")
        );
        assert!(!lib_rs.contains("resolve_export_caps"));
        ...
        assert_eq!(
            ...
            "//! Generated by `sand` — do not edit by hand.\n\
             ...
             //! print them as JSON. `#[function]` and `#[datapack_component]` items are discovered\n\
