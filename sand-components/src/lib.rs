...
pub use registry::{
    AdvancementId, BiomeId, BlockId, DamageTypeId, DimensionId, EnchantmentId, EntityTypeId,
    FunctionId, ItemId, LootTableId, PotionRegistryId, RecipeId, StatusEffectId, StructureId,
    TagId,
};
