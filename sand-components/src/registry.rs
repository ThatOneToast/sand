...
impl sand_commands::resource::sealed::Sealed<sand_commands::resource::EntityType> for EntityTypeId {}
...
registry_id! {
    @contract(
        ...
        local(
            minecraft = "Uses Sand's export-time namespace sentinel so the final datapack namespace is substituted when the function is emitted.",
            use_when = ["Referring to a #[function] generated by the current Sand project"],
            avoid_when = ["Referring to a function owned by Minecraft or another datapack"],
            example_path = "combat/on_hit",
...
impl sand_commands::resource::sealed::Sealed<sand_commands::resource::Predicate> for PredicateId {}
...
impl sand_commands::resource::sealed::Sealed<sand_commands::resource::SoundEvent> for SoundEventId {}
...
registry_id! {
    /// Typed Minecraft particle identifier (for example `minecraft:flame` or
    /// `mymod:arcane_spark`).
    ParticleId
}

impl sand_commands::resource::sealed::Sealed<sand_commands::resource::ParticleType> for ParticleId {}
...
impl sand_commands::resource::sealed::Sealed<sand_commands::resource::StatusEffect>
    for StatusEffectId
{
}
