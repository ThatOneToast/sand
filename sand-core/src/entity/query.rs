...
/// declarations accepted as system parameters.
#[doc(hidden)]
#[diagnostic::on_unimplemented(
...
pub trait SystemQueryParameter: 'static {}
...
impl<Q> StateQueryOperations for Q where Q: StateQuerySpec + SystemQueryParameter {}
...
where
    Q: StateQuerySpec + SystemQueryParameter,
