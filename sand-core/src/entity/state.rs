...
impl EntityFlag {
    ...
    #[sand_macros::api(
        ...
        aliases = ["sand::entity::Flag::new", "sand::prelude::EntityFlag::new", "sand::prelude::Flag::new"],
        module = "sand::entity",
        kind = "method",
    ...
    #[sand_macros::api(
        ...
        aliases = ["sand::entity::Flag::is_enabled", "sand::prelude::EntityFlag::is_enabled", "sand::prelude::Flag::is_enabled"],
        module = "sand::entity",
        kind = "method",
    ...
    #[sand_macros::api(
        ...
        aliases = ["sand::entity::Flag::is_disabled", "sand::prelude::EntityFlag::is_disabled", "sand::prelude::Flag::is_disabled"],
        module = "sand::entity",
        kind = "method",
...
impl EntityTimer {
    ...
    #[sand_macros::api(
        ...
        aliases = ["sand::entity::Timer::new", "sand::prelude::EntityTimer::new", "sand::prelude::Timer::new"],
        module = "sand::entity",
        kind = "method",
    ...
    #[sand_macros::api(
        ...
        aliases = ["sand::entity::Timer::elapsed", "sand::prelude::EntityTimer::elapsed", "sand::prelude::Timer::elapsed"],
        module = "sand::entity",
        kind = "method",
...
#[sand_macros::api(registry = sand_api_contract, path = "sand::entity::Cooldown", aliases = ["sand::prelude::Cooldown"], module = "sand::entity", summary = "Canonical cooldown field marker for #[derive(State)] declarations.", context = "The State derive turns this declaration marker into a scoped EntityCooldown handle.", minecraft = "Lowers to a non-negative scoreboard field that is ready at zero.", use_when = ["Declaring cooldown gameplay state"], avoid_when = ["Managing a standalone cooldown; use sand::advanced::state::Cooldown"], example = "#[derive(State)] struct Combat { dash: Cooldown }")]
pub type Cooldown = EntityCooldown;
...
impl EntityCooldown {
    ...
    #[sand_macros::api(
        ...
        aliases = ["sand::entity::Cooldown::new", "sand::prelude::Cooldown::new", "sand::prelude::EntityCooldown::new"],
        module = "sand::entity",
        kind = "method",
    ...
    #[sand_macros::api(
        ...
        aliases = ["sand::entity::Cooldown::ready", "sand::prelude::Cooldown::ready", "sand::prelude::EntityCooldown::ready"],
        module = "sand::entity",
        kind = "method",
