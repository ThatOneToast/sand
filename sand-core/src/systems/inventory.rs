...
impl InventorySystem {
    ...
    #[sand_macros::api(
        ...
        use_when = ["Opting into the documented higher-level gameplay behavior instead of assembling its commands manually"],
        avoid_when = ["Using the API outside its documented system scope or feature configuration"],
        params(slot = "`slot` restricts the inventory check to one slot.", item = "`item` selects the item or item predicate matched in that slot."),
    ...
    #[sand_macros::api(
        ...
        use_when = ["Opting into the documented higher-level gameplay behavior instead of assembling its commands manually"],
        avoid_when = ["Using the API outside its documented system scope or feature configuration"],
        params(slot = "`slot` supplies the documented `item replace entity <selector> <slot> with <item>` — replace a slot's contents form.", item = "`item` provides the item value or item predicate used to emit the documented `item replace entity <selector> <slot> with <item>` — replace a slot's contents form."),
    ...
    #[sand_macros::api(
        ...
        use_when = ["Opting into the documented higher-level gameplay behavior instead of assembling its commands manually"],
        avoid_when = ["Using the API outside its documented system scope or feature configuration"],
        params(slot = "`slot` supplies the documented `item replace entity <selector> <slot> with air` — clear a single slot form."),
...
impl HasItemCheck {
    ...
    #[sand_macros::api(
        ...
        use_when = ["Opting into the documented higher-level gameplay behavior instead of assembling its commands manually"],
        avoid_when = ["Using the API outside its documented system scope or feature configuration"],
        params(slot = "`slot` supplies the documented `execute if items entity <selector> <slot> <item>` — check in a specific slot form."),
    ...
    #[sand_macros::api(
        ...
        use_when = ["Opting into the documented higher-level gameplay behavior instead of assembling its commands manually"],
        avoid_when = ["Using the API outside its documented system scope or feature configuration"],
        params(slot = "`slot` supplies the documented `execute unless items entity <selector> <slot> <item>` — the negated form form."),
