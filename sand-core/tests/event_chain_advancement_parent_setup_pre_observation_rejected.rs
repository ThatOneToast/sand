//! An advancement-backed graph parent that declares `pre_observation` setup
//! is rejected (#240 Phase 6) — see
...
#[test]
fn advancement_parent_with_pre_observation_is_rejected() {
    let error = sand_core::try_export_components_json("advsetupprerejected").expect_err(
    ...
    assert!(
        message.contains("pre_observation"),
