...
fn main() {
    ...
    let give_vanilla = cmd::give(Target::self_(), vanilla::Item::Diamond);
    ...
    let give_typed = cmd::give(Target::self_(), diamond_id);
    ...
    let marker_selector = Target::entities().entity_type(vanilla::EntityType::Marker);
    ...
    let custom_selector = Target::entities().entity_type(custom_type);
