...
impl HudLayout {
    ...
    /// | 1920 × 1080 | 3 | 640 |
    /// | 2560 × 1440 | 2 | 1280 |
    #[doc = "**API Contract:** Run `sand api show sand::resourcepack::HudLayout::new` for the canonical contract."]
    ...
    #[doc = "**API Contract:** Run `sand api show sand::resourcepack::HudLayout::bar` for the canonical contract."]
    ...
    #[doc = "**API Contract:** Run `sand api show sand::resourcepack::HudLayout::element` for the canonical contract."]
    ...
    ///     .broadcast("@a");
    /// ```
    #[doc = "**API Contract:** Run `sand api show sand::resourcepack::HudLayout::tracked_bar` for the canonical contract."]
    ...
    /// }
    /// ```
    #[doc = "**API Contract:** Run `sand api show sand::resourcepack::HudLayout::broadcast` for the canonical contract."]
    ...
    ///
    /// [`broadcast_via_storage`]: HudLayout::broadcast_via_storage
    #[doc = "**API Contract:** Run `sand api show sand::resourcepack::HudLayout::setup_storage` for the canonical contract."]
    ...
    #[doc = "**API Contract:** Run `sand api show sand::resourcepack::HudLayout::broadcast_via_storage` for the canonical contract."]
    ...
    #[doc = "**API Contract:** Run `sand api show sand::resourcepack::HudLayout::show_elements` for the canonical contract."]
