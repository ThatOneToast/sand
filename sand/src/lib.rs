...
pub mod entity {
    pub use sand_core::entity::{
        ...
        MutableLivingEntityKind, NameBinding, NumericPropertySource, NumericStateField,
        NumericStateSource, OverflowPolicy, OwnershipPolicy, PlayerKind, PropertyNameError,
