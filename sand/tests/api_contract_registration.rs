...
fn generated_registrations_build_an_installed_catalog() {
    ...
    assert_eq!(coverage.static_surface_items, 11_032);
    assert_eq!(coverage.pending_item_ceiling, 2_655);
    assert_eq!(coverage.pending_scope_ceiling, 5);
    assert_eq!(coverage.pending_scopes.len(), 5);
    ...
    assert_eq!(effect.canonical_path, "sand::prelude::EffectId::Speed");
    ...
    let condition = catalog
        ...
        .expect("definition-owned condition method contract");
    assert_eq!(
