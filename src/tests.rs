...
#[cfg(test)]
mod tests {
    use crate::{commands::{clear, effect, gamemode::GameMode, kill, teleport, Distance, PlayerCommands, TargetFilter}, selector::{EntityTargets, TargetSelector}, status_effects};
    ...
    fn test_gamemode() {
        ...
        assert_eq!(command.to_string(), "/gamemode survival @a[name=TheOneTrueToast]");
        ...
        assert_eq!(command.to_string(), "/gamemode spectator @a[level=10,name=TheOneTrueToast]");
    }
    
    #[test]
    fn test_teleport() {
        let command = PlayerCommands::Teleport(teleport::Teleport::PlayerToPlayer("test".to_string(), "toast".to_string()));
    ...
    fn test_kill() {
        ...
        assert_eq!(command.to_string(), "/kill @a[level=10,name=TheOneTrueToast]");
    }
    ...
    fn test_effect() {
        ...
        assert_eq!(command.to_string(), "/effect give @a[name=TheOneTrueToast] blindness 30 0");
        ...
        assert_eq!(command.to_string(), "/effect clear @a[name=TheOneTrueToast]");
    }
